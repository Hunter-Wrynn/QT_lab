...
#include "ui_teapassmod.h"

TeaPassMod::TeaPassMod(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::TeaPassMod)
{
    ui->setupUi(this);

    this->setWindowTitle(QStringLiteral("教师密码修改界面"));
    QRegExp regx("[0-9]+$");
